...
class MD5 final	 // cppcheck-suppress noConstructor
{
public:
...
private:
	...
	static constexpr auto md5_blocksize = 64;

	inline void transform (const unsigned char block[md5_blocksize]) noexcept
	{
		std::uint32_t x[16];
