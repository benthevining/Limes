...
/** @defgroup limes_locale limes_locale
	...
	This group contains information about various languages and countries, useful for internationalizing software.
...
/** @dir libs/limes_core/locale
	This directory contains localization utilities.
...
/** @dir libs/limes_core/locale/languages
...
struct LIMES_EXPORT Language final
{
	...
	explicit Language (const std::string_view& name,
					   ...
					   const std::vector<std::string>& countries   = {},  // NOLINT
...
/** Returns a %vector of Language objects representing languages that may be spoken in the given %country.
	@ingroup loc_lang
 */
[[nodiscard]] LIMES_EXPORT std::vector<Language> getLanguagesForCountry (const std::string_view& countryCode);

/** Returns all known Language objects in Limes's internal database.
	These should not be mutated!
	@ingroup loc_lang
 */
[[nodiscard]] LIMES_EXPORT const std::vector<Language>& getAllKnownLanguages();
