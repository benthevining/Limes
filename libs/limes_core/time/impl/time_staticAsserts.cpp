...
static_assert (Month{ Month::Name::December }++.getMonthName() == Month::Name::January, "Month::operator++");
static_assert (Month{ Month::Name::January }--.getMonthName() == Month::Name::December, "Month::operator--");
