...
//#include <version.pb.h>       // generated by protobuf
...
/** @dir libs/limes_core/data_structures
	This directory contains data structures.
	@ingroup data_structures
 */

/** @dir libs/limes_core/data_structures/version
	This directory contains the Version class.
	@ingroup data_structures
 */
...
/** This namespace contains data structures.
	@ingroup data_structures
 */
namespace ds
{
 ...
 */
template <>
struct LIMES_EXPORT hash<limes::ds::Version>
{
	hash() = default;
	...
	size_t operator() (const limes::ds::Version& v) const noexcept;
};
}  // namespace std
